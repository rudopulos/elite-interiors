  ...
  return <div className="min-h-screen bg-[#FAF9F7] text-[#23272B]">
      ...
      duration: 0.5
        ...
        <motion.div className="relative z-10 p-4" variants={fadeIn} initial="initial" animate="animate">
          ...
          <p className="modern-sans text-lg md:text-xl max-w-2xl mx-auto text-[#23272B]/80">Noi creeăm interioare durabile și plăcute estetic. Alegem materiale de înaltă calitate și tehnici inovatoare, pentru a creea spații ce rămân relevante și apreciate indiferent de trecerea timpului.</p>
        </motion.div>
      </motion.section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="md:w-1/2">
              ...
              <p className="modern-sans text-lg mb-4">
                La Elite Interiors, credem că designul interior este mai mult decât estetică, este despre crearea de experiențe și spații care îmbunătățesc viața. Abordarea noastră combină arta cu funcționalitatea, asigurându-ne că fiecare proiect nu este doar frumos, ci și perfect adaptat nevoilor clientului.
              </p>
